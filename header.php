...
<head>
    ...
    <link href="css/bowercomponent/simplePagination.css" rel="stylesheet">
    ...
    <header id="header-wrapper">
        <div class="top-header">
            <div class="custom-container">
                <h1><a href="index.php">Sanjeev Baskiyar, PhD</a></h1>
                <h2>Professor</h2>
            </div>
        </div>
        ...
        <div class="bottom-header">
            <div class="custom-container small-padding-top-bottom">
                <ul>
                    ...
                    <li>
                        <a href="professional-activities.php">Professional Activities</a>
                    </li>
                </ul>
            </div>
        </div>
